...
interface ProgressProvideValue {
  modelValue?: Readonly<Ref<BaseProgressProps["modelValue"]>>;
...
import { BaseProgressProps, BaseProgressEmits } from "./types";
...
const modelValue = useVModel<number | null>(props, "modelValue", emit, {
  passive: true,
});

const max = useVModel<number>(props, "max", emit, {
  passive: true,
});
