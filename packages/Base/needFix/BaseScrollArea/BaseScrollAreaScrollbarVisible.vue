...
import BaseScrollAreaScrollbarX from './BaseScrollAreaScrollbarX.vue'
import BaseScrollAreaScrollbarY from './BaseScrollAreaScrollbarY.vue'
import {
...
<template>
  <BaseScrollAreaScrollbarX v-if="isShowingScrollbarX" v-bind="$attrs">
    <slot />
  </BaseScrollAreaScrollbarX>
  <BaseScrollAreaScrollbarY v-else v-bind="$attrs">
    <slot />
  </BaseScrollAreaScrollbarY>
</template>