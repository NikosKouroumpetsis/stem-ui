...
import { ROVING_FOCUS_INJECTION_KEY } from "./BaseRovingFocusGroup.vue";
import { focusFirst, getFocusIntent, wrapArray } from "./utils";
import { useCollection, useId } from "../../Core/shared";
import { Primitive } from "../../Core/primitive";
import { BaseRovingFocusItemProps } from "./types";

const props = withDefaults(defineProps<BaseRovingFocusItemProps>(), {
  focusable: true,
  active: true,
  as: "span",
});
